...
const DATA_sortOrderRadios = [
  { name: "Best Rating", id: "1" },
  { name: "Most Popular", id: "2" },
  { name: "Newest", id: "3" },
...
const SidebarFilters = () => {
  ...
  const renderTabsCategories = () => {
    return (
      <div className="relative flex flex-col pb-8 space-y-4">
        <h3 className="font-semibold mb-2.5">Brand</h3>
  ...
  const renderTabsColor = () => {
    return (
      <div className="relative flex flex-col py-8 space-y-4">
        <h3 className="font-semibold mb-2.5">Product Category</h3>
  ...
  const renderTabsSortOrder = () => {
    return (
      <div className="relative flex flex-col py-8 space-y-4">
        <h3 className="font-semibold mb-2.5">Sort</h3>
  ...
  return (
    <div className="divide-y divide-slate-200 dark:divide-slate-700">
      ...
      <div className="py-8 pr-2">
        <MySwitch
          label="Proof of Product"
          desc="This item has a digital twin."
          enabled={isOnSale}
